module.exports = class Data1749194363699 {
    name = 'Data1749194363699'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "trigger_new_riddle" ("id" character varying NOT NULL, CONSTRAINT "PK_5aae5f3216ce7db1eea0c59652f" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "trigger_new_riddle"`)
